...
export default function SidebarEmploye({ onClose }) {
  ...
  return (
    <aside className="w-56 bg-red-900 flex flex-col h-screen">
      ...
      <div className="mx-3 mt-3 bg-white/10 rounded-xl p-3 flex items-center gap-3">
        <div className="w-8 h-8 rounded-full bg-red-200 flex items-center justify-center text-red-900 text-xs font-bold flex-shrink-0">
          {initiales}
        </div>
        <div>
